 ...
 */
#define PKTGENCAP_RX_ISLANDS 1
#define PKTGENCAP_TX_ISLANDS 1
#define PKTGENCAP_RXTX_ISLANDS (PKTGENCAP_RX_ISLANDS+PKTGENCAP_TX_ISLANDS)
...
#define PKTGEN_INIT_STAGES 8
#define PKTGEN_INIT_STAGE_CSR_INIT      2
#define PKTGEN_INIT_STAGE_PREHOST_LOAD  4
#define PKTGEN_INIT_STAGE_HOST_STARTED  6
#define PKTGEN_INIT_STAGE_READY_TO_RUN  8

#define PCAP_INIT_STAGES 8
#define PCAP_INIT_STAGE_CSR_INIT      2
#define PCAP_INIT_STAGE_PREHOST_LOAD 4
#define PCAP_INIT_STAGE_READY_TO_RUN 8
